...
public class Calculator {
	...
	void intputData(int a, double d) {}

	void intputData(double d, int a) {}

	//	void inputData(int number) {} (x) 정수 매개값 1개를 받는 메서드가 이미 선언됨

	//	int inputData(int number){
	//		return 0; } (x) 반환 유형 (return type)은 오버로딩에 영향에 미치지 못합니다.
	...
	double calcRectArea(int width1, int width2, int height) {
