...
public class MethodExample3 {
	...
	static int[] oprateTotal(int n1, int n2) {
	...
	static void divde(int n1, int n2) {
		if (n2 == 0) {
	...
	public static void main(String[] args) {
		...
		int r2 = add(10, 15); // int t2 = 25
		int r3 = add(add(4, 6), add(7, 8));
		System.out.println(r3);

		int[] totalResult = oprateTotal(30, add(2, 3));
        ...
        {57, 89, 78, 91, 93, 47}
		 */
		double[] rt = calcArrayTotal(new int[] {57, 89, 78, 91, 93, 47});
		System.out.print("합계: " + (int)rt[0]);
